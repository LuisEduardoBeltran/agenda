...
(function($) {
   ...
   $.widget("ui.weekCalendar", {
       ...
       options : {
         ...
         buttons : true,
         buttonText : {
            lastWeek : "<img src='images/iconos_izq.png' width='50px' style='padding:0px;'>",
            today : "<img src='images/icono_hoy.png' width='50px' style='padding:0px;'>",
            nextWeek : "<img src='images/iconos_izq.png' width='50px' style='padding:0px; transform: scaleX(-1)'>"
      ...
      _renderCalendar : function() {
         ...
         if (options.buttons) {
            calendarNavHtml = "<div class=\"wc-nav\">\
                    <button class=\"wc-today\" style='padding:0px;'>" + options.buttonText.today + "</button>\
                    <button class=\"wc-prev\" style='padding:0px;'>" + options.buttonText.lastWeek + "</button>\
                    <button class=\"wc-next\" style='padding:0px;'>" + options.buttonText.nextWeek + "</button>\
                    </div>";
